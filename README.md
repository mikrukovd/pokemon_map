...
Создайте суперпользователя для входа в админку сайта
...
После запуска сервера необходимо перейти по ссылке [http://127.0.0.1:8000](http://127.0.0.1:8000). Там откроется сайт на котором будут отображаться покемоны на карте.
Покемоны и информация о них добавляется в админке сайта [http://127.0.0.1:8000/admin](http://127.0.0.1:8000/admin). Для входа в админку потребуются данные суперпользователя.
